...
// If validation should be done, get a list of the required validation layers
// names and make sure they exists. Validation layers should only be enabled
// on non-release builds.
  ...
  // Obtain a list of validation layers
  ...
  for (u32 i = 0; i < required_validation_layer_count; ++i) {
    KINFO("Search for layer: %s...", required_validation_layer_names[i]);
    b8 found = FALSE;
  ...
  KINFO("All required validation are present.");
#endif
