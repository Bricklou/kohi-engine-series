...
void vulkan_renderpass_create(vulkan_context *context, vulkan_renderpass *out_renderpass, f32 x,
                              f32 y, f32 w, f32 h, f32 r, f32 g, f32 b, f32 a, f32 depth,
                              u32 stencil) {
  ...
  u32 attachments_description_count = 2;
  VkAttachmentDescription attachments_descriptions[attachments_description_count];
  ...
  attachments_descriptions[0] = color_attachment;
  ...
  attachments_descriptions[1] = depth_attachment;
  ...
  // TODO: other attachents types (input, resolve, preserve)
  ...
  render_pass_create_info.attachmentCount = attachments_description_count;
  render_pass_create_info.pAttachments = attachments_descriptions;
...
void vulkan_renderpas_destroy(vulkan_context *context, vulkan_renderpass *renderpass) {
...
void vulkan_renderpass_begin(vulkan_command_buffer *command_buffer, vulkan_renderpass *renderpass,
  ...
  kzero_memory(clear_value, sizeof(VkClearValue) * 2);
