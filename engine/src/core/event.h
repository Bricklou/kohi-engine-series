 ...
 * with duplicate listener/callback will not be registered and will cause this
 * to return FALSE.
 ...
 * code is fired.
 * @returns TRUE if the event is successfuly registered; otherwise false
 */
 ...
 * not matching registration is found, this function returns FALSE.
...
/**
 * Fire an event to listeners of the given code. If an event handler returns
